                            ...
                            <td>
                                <div class="files-info">
                                    <button class="btn btn-sm btn-success files-btn accepted-btn" @click="openAcceptedFilesModal(project)">
                                        ...
                                        <span x-text="'Accepted (' + project.acceptedFiles + ')'"></span>
                                    </button>
                                    <button class="btn btn-sm btn-danger files-btn rejected-btn" @click="openRejectedFilesModal(project)">
                                        <i class="fas fa-times"></i>
                                        <span x-text="'Rejected (' + project.rejectedFiles + ')'"></span>
                                    </button>
                                </div>
                            </td>
                            <td>
                                <div class="actions-cell">
                                    <button class="btn btn-xs btn-secondary" @click="viewProgress(project)" title="View Details">
